...
const models: TsoaRoute.Models = {
    ...
    "IFormConfig": {
        ...
        "properties": {
            ...
            "stepper": {"dataType":"nestedObjectLiteral","nestedProperties":{"props":{"dataType":"nestedObjectLiteral","nestedProperties":{"shape":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["round"]},{"dataType":"enum","enums":["line"]}]},"color":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["primary"]},{"dataType":"enum","enums":["secondary"]},{"dataType":"enum","enums":["inherit"]}]},"variant":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["dots"]},{"dataType":"enum","enums":["progress"]},{"dataType":"enum","enums":["text"]}]}}},"name":{"dataType":"string","required":true}}},
        },
