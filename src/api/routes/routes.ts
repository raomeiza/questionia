...
const models: TsoaRoute.Models = {
    ...
    "IFormConfig": {
        ...
        "properties": {
            ...
            "questions": {"dataType":"nestedObjectLiteral","nestedProperties":{"progressType":{"dataType":"string"},"showProgress":{"dataType":"boolean"},"type":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["default"]},{"dataType":"enum","enums":["paged"]},{"dataType":"enum","enums":["single"]}]},"allowEdit":{"dataType":"boolean"},"allowPrevious":{"dataType":"boolean"}}},
            "stepper": {"dataType":"nestedObjectLiteral","nestedProperties":{"props":{"dataType":"nestedObjectLiteral","nestedProperties":{"shape":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["round"]},{"dataType":"enum","enums":["line"]}]},"color":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["primary"]},{"dataType":"enum","enums":["secondary"]},{"dataType":"enum","enums":["inherit"]}]},"variant":{"dataType":"union","subSchemas":[{"dataType":"enum","enums":["dots"]},{"dataType":"enum","enums":["progress"]},{"dataType":"enum","enums":["text"]},{"dataType":"enum","enums":["outlined"]}]}}},"name":{"dataType":"string","required":true}}},
        },
    ...
    "ICreate": {
        ...
        "properties": {
            ...
            "answers": {"dataType":"nestedObjectLiteral","nestedProperties":{},"additionalProperties":{"dataType":"any"}},
            "maxAllowedTime": {"dataType":"double"},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.patch('/form/:formId/answers',
            ...(fetchMiddlewares<RequestHandler>(formController)),
            ...(fetchMiddlewares<RequestHandler>(formController.prototype.updateAnswers)),

            function formController_updateAnswers(request: any, response: any, next: any) {
            const args = {
                    sendSuccess: {"in":"res","name":"200","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"message":{"dataType":"string","required":true},"success":{"dataType":"enum","enums":[true],"required":true}}},
                    sendError: {"in":"res","name":"500","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"error":{"dataType":"object","required":true},"message":{"dataType":"string","required":true},"status":{"dataType":"double","required":true},"success":{"dataType":"enum","enums":[false],"required":true}}},
                    formId: {"in":"path","name":"formId","required":true,"dataType":"string"},
                    payload: {"in":"body","name":"payload","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"maxAllowedTime":{"dataType":"double"},"type":{"dataType":"enum","enums":["quiz"],"required":true},"answers":{"dataType":"nestedObjectLiteral","nestedProperties":{},"additionalProperties":{"dataType":"any"},"required":true}}},
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
            ...
            try {
              ...
              const promise = controller.updateAnswers.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.patch('/form/:formId/max-time',
            ...(fetchMiddlewares<RequestHandler>(formController)),
            ...(fetchMiddlewares<RequestHandler>(formController.prototype.updateQuizMaxTime)),

            function formController_updateQuizMaxTime(request: any, response: any, next: any) {
            const args = {
                    sendSuccess: {"in":"res","name":"200","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"message":{"dataType":"string","required":true},"success":{"dataType":"enum","enums":[true],"required":true}}},
                    sendError: {"in":"res","name":"500","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"error":{"dataType":"object","required":true},"message":{"dataType":"string","required":true},"status":{"dataType":"double","required":true},"success":{"dataType":"enum","enums":[false],"required":true}}},
                    formId: {"in":"path","name":"formId","required":true,"dataType":"string"},
                    payload: {"in":"body","name":"payload","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"type":{"dataType":"enum","enums":["quiz"]},"maxAllowedTime":{"dataType":"double","required":true}}},
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
            ...
            try {
              ...
              const promise = controller.updateQuizMaxTime.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
